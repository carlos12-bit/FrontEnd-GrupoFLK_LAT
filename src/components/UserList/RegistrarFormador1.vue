<template>
    <div class="register-formador-container">
      ...
      <el-dialog title="Éxito" :visible.sync="dialogVisible" width="30%">
        <span>El formador ha sido registrado con éxito.</span>
        ...
        this.$refs.form.validate(async (valid) => {
          if (valid) {
            try {
              ...
              // Insertar el formador en la base de datos
              ...
              console.error('Error al registrar formador:', error);
            }
          } else {
