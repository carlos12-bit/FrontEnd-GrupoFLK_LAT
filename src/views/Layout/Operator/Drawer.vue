...
<el-sub-menu index="1">
      <template #title>
        ...
        <span>GESTIONAR EVALUACION</span>
      </template>
        ...
        <el-menu-item index="1-2">
          ...
          <router-link class="nav-link" to="/operator-dashboard/PerformanceReport">
    ...
    <el-sub-menu index="2">
      ...
      <el-menu-item index="2-1">
        <img src="@/assets/evaluacion.png" alt="Icono Sesiones" class="menu-icon3" />
        <router-link class="nav-link" to="/operator-dashboard/CertificateState">
