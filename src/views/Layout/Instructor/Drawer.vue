<template>
  ...
  <el-menu v-if="!isMobile || !isCollapse" default-active="1-1" class="el-menu-vertical-demo" :collapse="isCollapse"
    ...
    <el-sub-menu index="1">
      ...
      <el-menu-item index="1-1">
        <img src="@/assets/clases.png" alt="Icono Sesiones" class="menu-icon1" />
        <router-link class="nav-link" to="/Instructor-dashboard/CalendarActivities">
          Calendario de Actividades
        </router-link>
      </el-menu-item>
      <el-menu-item index="1-2">
        <img src="@/assets/asistencia.png" alt="Icono Sesiones" class="menu-icon3" />
        <router-link class="nav-link" to="/Instructor-dashboard/GestionarAsistencia">
    ...
    <el-sub-menu index="2">
      ...
      <el-menu-item index="2-1">
        <img src="@/assets/evaluacion.png" alt="Icono Sesiones" class="menu-icon3" />
        <router-link class="nav-link" to="/Instructor-dashboard/ManageEvaluation">
          Evaluacion Practica
        </router-link>
      </el-menu-item>
    </el-sub-menu>
  ...
  <button v-if="isMobile" class="hamburger-menu" @click="toggleCollapse" :class="{ 'active': isCollapse }">
    <span class="bar"></span>
    <span class="bar"></span>
    <span class="bar"></span>
  </button>
